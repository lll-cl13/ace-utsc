  ...
  return (
    <div className="relative bg-white text-[#222] flex-1 flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 px-[45px] py-10 md:py-12">
        ...
        <p className="mb-6 text-[15.5px] leading-[1.72]">ACE UTSC has proudly received sponsorship from a range of reputable organizations, including:</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 text-center">
          <div>
            ...
            <div className="font-semibold text-sm">EY</div>
          </div>
          <div>
            ...
            <div className="font-semibold text-sm">UofT MMPA</div>
          </div>
          <div>
            ...
            <div className="font-semibold text-sm">ICUBE UTM</div>
          </div>
          <div>
            ...
            <div className="font-semibold text-sm">CFA Society</div>
          </div>
        </div>

        <p className="text-[15.5px] leading-[1.72]">
